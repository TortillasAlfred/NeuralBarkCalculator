...
def main(args):
    ...
    exp = Experiment(directory=os.path.join(args.root_dir, 'best_attempt_11'),
                     module=module,
    ...
    with torch.no_grad():
        for image_number, (batch, pure_batch) in enumerate(
            ...
            plt.savefig(os.path.join(
                args.root_dir,
                'Images/results/best_attempt_11/combined_images/{}/{}/{}').
