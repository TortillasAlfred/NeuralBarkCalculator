...
def generate_output_folders(root_dir):
    ...
    results_dir = os.path.join(root_dir, 'Images', 'results', 'other_attempt')
...
def main(args):
    ...
    exp = Experiment(directory=os.path.join(args.root_dir, 'other_attempt'),
                     module=module,
    ...
    with torch.no_grad():
        for image_number, (batch, pure_batch) in enumerate(
            ...
            plt.savefig(os.path.join(
                args.root_dir,
                'Images/results/other_attempt/combined_images/{}/{}/{}').
