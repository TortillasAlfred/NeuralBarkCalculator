...
def main():
    ...
    train_loader = DataLoader(Subset(train_dataset, train_split.repeat(5)), batch_size=16, shuffle=True, num_workers=8)
    valid_loader = DataLoader(Subset(test_dataset, valid_split), batch_size=1, num_workers=8)
